...
class Radio(object):
    ...
    def broadcast(self, buff = ""):
        """Broadcast a message to network i.e. sends to node 255 with no ACK request and only 1 attempt.
        ...
        self.send(broadcastAddress, buff, require_ack=False, attempts=1)
